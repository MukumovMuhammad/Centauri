...
class DialogWindows(var context: Context) {
    ...
    fun fullImageFragment(url : String){
        val imgDialog = FullImageDialogFragment(url)
        imgDialog.show((context as AppCompatActivity).supportFragmentManager, "FullImageDialog")
    }
